...
> thresholds — I prefer getting a yellow warning at 60% usage instead of the default 80%,
> since I tend to hit context limits mid-task. See `src/utils/renderer.ts` for the relevant
> constants.
